...
<link rel="stylesheet" type="text/css" href="styles/style.css">
 ...
 <? include('CF_header.php'); ?>
      <!-- content -->
      <h1 style="margin-bottom:30px;" class="Heading-1" >Logged Out Successfully</h1>
	  <span class="pagedesc">You are now logged out of the Cycle Folsom Membership Tools system.  You can <a href="http://www.cyclefolsom.com/member-tools">log back in</a> or return to the Cycle Folsom <a href="http://www.cyclefolsom.com">home page.</a></span>
