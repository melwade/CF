	...
	if ( $token != "" )
	{
		...
		*/
		...
		if( $ackGetExpressCheckout == "SUCCESS" || $ackGetExpressCheckout == "SUCESSWITHWARNING") 
		{
			...
			* page		
			*/
			$customlinky 				= $resArrayGetExpressCheckout["PAYMENTREQUEST_0_CUSTOM"]; // ' Email address of payer.
	...
	<div class="span5">
		<table>
			<tbody>
				...
				<tr><td>Custom field:</td><td><?php echo $customlinky   		?></td></tr>
				<tr><td>My field:</td><td><?php echo $mylinky   		?></td></tr>
