...
if ($number>0){
	    ...
	    $end_result = '';
		echo "<table bgcolor='#a20000' border='0' width='650'><tr bgcolor='#a20000'><th class='jtable'><font color='#fff'>Name</font></th><th class='jtable'><font color='#fff'>Phone</font></th><th class='jtable'><font color='#fff'>Email</font></th></tr>";
		while ($row = mysql_fetch_array($result)) {
			...
			//Here we show different views based on whether they chose to have their profile public or private
				...
				echo "<tr bgcolor=$bgcolor ><td class='jtable' width='200'>$row[fname]". " ". "$row[lname]</td><td class='jtable' align='center' width='150'>$row[phone]</td><td class='jtable' align='center' width='300'><a href=\"#\" onclick=\"TINY.box.show({url:'show_member.php',post:'id=$row[id]',width:240,height:55,opacity:20,topsplit:3})\">Show Details</a></td></tr>";
