...
<link rel="stylesheet" type="text/css" href="styles/style.css">
 ...
 <? include('CF_header.php'); ?>
      <!-- content -->
      <h1 class="Heading-1" style="margin-bottom:30px;">Error</h1>
      <span class="pagedesc">There was a problem saving your changes.  Please <a href="/contact.php">contact</a> the Cycle Folsom admin.<br><br> You can now <a href="logout.php">logout</a>, <a href="index.php">manage your member profile</a>,  visit the <a href="/membership-tools.html">membership tools</a> page, or return to the <a href="/index.html">Cycle Folsom home page</a>.</span>
