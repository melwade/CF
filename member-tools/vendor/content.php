...
if ($_SESSION['isadmin']){
echo "<div style='float: left;'><h1 class='Heading-1' style='margin-bottom:30px;'>Member Profile</h1></div><div style='float: right; margin-right:57px;'><a href='admin/'><img src='images/admin_tools.png'></a><br><a href='logout.php'><img src='images/logout_sm.png'></a></div>";}
else {echo "<div style='float: left;'><h1 class='Heading-1' style='margin-bottom:30px;'>Member Profile</h1></div><div style='float: right; margin-right:57px;'><a href='logout.php'><img src='images/logout_sm.png'></a></div>";}
echo "<div style='clear: both;'></div>";
echo "<span class='pagedesc'>Your profile, membership status, and payment history are shown below. You may edit your profile or renew your membership at any time.  If you'd like to </span><span class = 'cancelred'>cancel </span><span class='pagedesc'>your membership, you can do so by clicking <a href='cancel_membership.php'>here</a></span>.";
//Lookup user info
...
while ($item = mysql_fetch_array($result)) {
    ...
    <input type="image" src="images/edit_profile.png" border="0" alt="Submit" /></form>
    </div>
    </div>
     <div id="cfwrapper2" style="min-height:100px;">
    <h5 class="subtitle" style="margin-bottom:0;">Membership Status</h5>
	       <hr class="cf">
	...
	<table width="100%" border="0"> 
	 ...
	 switch ($item['payment_status']) {
		...
		case "Unpaid":
		?><tr><td width="150" class="cf" align="right">Membership Status:&nbsp;&nbsp;</td><td class="cfred">Unpaid - To complete registration, use the "Pay Fee" button at right.</td></tr>
		...
		case "Expired":
		if($item['coupon_user']=="Yes"){
		?><tr><td width="150" class="cf" align="right" valign="top">Membership Status:&nbsp;&nbsp;</td><td class="cfred">Expired - To renew registration, use the "Apply Coupon" button at right.  If you do not have a coupon code, click <span style="font-weight:bold;"><a href="mailto:info@cyclefolsom.com?Subject=Cycle%20Folsom--Coupon%20Code%20Request">HERE</a> to request one.</td></tr> <?
		} else { ?>
	...
	if($item['payment_status']=="Pending" or $item['payment_status']=="No Waiver" or ($coupon_user="Yes" and $numdays > 60)) { 
	?>
...
$subject = "Cycle Folsom Password Reset Request";
...
$headers .= 'From: <jason@cyclefolsom.com>' . "\r\n";
...
$subject = "Notification of Cycle Folsom Password Reset Request";
