...
<link rel="stylesheet" type="text/css" href="styles/style.css">
 ...
 <body>
      ...
      <!-- content -->
      <h1 class="Heading-1" style="margin-bottom:30px;">PayPal Transaction Cancelled</h1>
      <BR>Your PayPal transaction has been cancelled.
	  <br><br><a href="index.php">Return to Membership Tools Page</a>
