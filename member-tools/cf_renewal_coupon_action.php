...
//Remove coupon code from DB
	$delqry="DELETE from tblCouponCodes where code = '$coupon_code'";
...
//Send Admin email notifying of new coupon user
	...
	$mail->Body     = "
		...
		<body>
		<p><strong>A Coupon has been used for a New Renewal. Please log in to the CF Registration System Admin Tools page and...</strong></p>
...
<link rel="stylesheet" type="text/css" href="styles/style.css">
 ...
 <body>
      ...
      <span class="pagedesc">Your renewal is now complete pending administrator approval. You can now <a href="logout.php">logout</a>, <a href="index.php">manage your member profile</a>, visit the <a href="/membership-tools.html">membership tools</a> page, or return to the <a href="/index.html">Cycle Folsom home page</a>.</span>
