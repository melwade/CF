...
<link rel="stylesheet" type="text/css" href="styles/style.css">
 ...
 <? include('CF_header.php'); ?>
	  ...
	  <span class="pagedesc">This form is used to confirm the membership contact info we have on file for you, to renew the liability waiver we have on file for you, and to launch the payment system (credit card info is NOT kept on file). You can edit your profile before continuing, or at any time after registration.</span>
	<?  
...
Upon payment completion, you will be taken to a confirmation page with additional information and links for joining our Meetup.com site so you can see our complete calendar. Meetup.com is free, but you’ll need to become a Meetup member and then request to join our Meetup Group.</p> 
                ...
                <input type="hidden" name="PAYMENTREQUEST_0_AMT" value="15.00"></input><input type="hidden" name="checkout">
