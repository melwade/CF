...
<link rel="stylesheet" type="text/css" href="member_tools_style.css" />
 ...
 <? include('CF_header.php'); ?>
      <!-- content -->
      <h1 style="margin-bottom:30px;" class="Heading-1" >Annual Membership Renewal</h1>
	  <span class="pagedesc">This form is used to confirm the membership contact info we have on file for you, to renew the liability waiver we have on file for you, and to enter the coupon code you have been given for free registration. You can edit your profile before continuing, or at any time after registration.</span>
      <p style="margin-top:25px;"><form id="CFCouponForm" name="CFCouponForm" class="form" action="cf_renewal_coupon_action.php" method="POST"><input type="hidden" name="checkout">
      <input type="text" name="coupon_code" id="coupon_code"/><span class="answer" style="color:#A10000; margin-left:5px;">After entering the coupon code, a message box will appear and let you know if the code is valid.</span></p>
	<?  
