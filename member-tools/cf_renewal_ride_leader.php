...
<html class="html">
 ...
 <script src="js/gen_validatorv4.js" type="text/javascript"></script>
  ...
  <title>Annual Membership Renewal</title>
  <!-- CSS -->
...
<link rel="stylesheet" type="text/css" href="member_tools_style.css" />
 ...
 <? include('CF_header.php'); ?>
      <!-- content -->
      <h1 style="margin-bottom:30px;" class="Heading-1" >Annual Membership Renewal for Ride Leaders, Ride Leader Family Members, and Sponsors</h1>
      <span class="pagedesc">This form is used to confirm the membership contact info we have on file for you, to renew the liability waiver we have on file for you, and to complete your registration. You can edit your profile before continuing, or at any time after registration.</span>
...
while ($item = mysql_fetch_array($result)) {
    ...
    <input type="image" src="images/edit_profile.png" border="0" alt="Submit" /></form></div>
    </div>
...
?>
 <h5 class="subtitle" style="margin-bottom:0; margin-top:30px;">Membership Type </h5>
		   ...
		   <table width="100%"><tr><td width="50"><img src="images/checkmark.jpg" height="30"></td><td style="font-size:14px; font-weight:bold;">Premium Membership for Ride Leaders, Ride Leader Family Members, and Sponsors<span style="font-weight:normal;"> (annual $15 registration fee waived)</span></td></tr>
      
      
	  <tr><td height="84">&nbsp;</td><td>Ride Leaders, Ride Leader Family Members, and Sponsors receive Premium Member benefits, which include:<br><br><ul>
      <li>Added Ride Leader discounts wherever available.</li>
      ...
      <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
            ...
            <tr><td>&nbsp;</td><td>Your Premium Membership card can be used to receive discounts from various sponsors, including 20% off at Pete’s Restaurant & Brewhouse and more. Some sponsors sometimes make special special discounts available to our ride leaders, including Folsom Bike, Town Center Bike and Tri, and ROL Wheels.<br><br>Your Premium Membership Card will typically be mailed to you within a week or less.</td></tr>
	 ...
	 <form id="CFCouponForm" name="CFCouponForm" class="form" action="cf_renewal_ride_leader_action.php" method="POST"><input type="hidden" name="checkout"> 
      <input type="hidden" value="<? echo $id; ?>" name="account_id" id="account_id">
	  ...
	  <h5 style="margin-top:50px;" class="subtitle">Important note if you were removed from our Meetup site:</h5><hr class="cf">
	  <p>If you let your membership lapse and were removed from Cycle Folsom's Meetup site, you'll need to complete this renewal and then submit a new request from our site on <a href="http://www.meetup.com/cyclefolsom">Meetup.com/cyclefolsom.</a></p>
	  <h5 style="margin-top:50px;" class="subtitle">Complete Your Renewal</h5><hr class="cf">
	  <p>Click the "Renew Membership" button below to renew your registration</p>
						
						<div id="cfwrapper"><div id="cfleftcolumn">
                       <br><input type="image" src="images/renew_membership.png" alt="Proceed to Checkout" value="Proceed to Checkout" /> 
                       <br><a href="index.php"><img src="images/cancel_renewal.png" alt="Cancel Renewal" value="Cancel Renewal" /></a> 
						
                      
            </form></div><div id="cfrightcolumn"><p style="margin-top:15px;"><a href="logout.php"><img src="images/logout.png"></a></p></div></div>
  	 <script type="text/javascript">var frmvalidator  = new Validator("CFCouponForm");
	 ...
	 frmvalidator.addValidation("coupon_code","req","Please enter a valid coupon code.");
