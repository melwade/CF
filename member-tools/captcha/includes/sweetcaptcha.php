...
define('SWEETCAPTCHA_APP_ID', 00000); // your application id (change me)
define('SWEETCAPTCHA_KEY', ''); // your application key (change me)
define('SWEETCAPTCHA_SECRET', ''); // your application secret (change me)
define('SWEETCAPTCHA_PUBLIC_URL', ''); // public http url to this file
