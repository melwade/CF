...
?>
      ...
      <h1 class="Heading-1" style="margin-bottom:25px;">Expiring Users</h1>
	  <?
		include ('connect.php');
...
FROM tblUserData
WHERE
	DATEDIFF(DATE(expiration_date), CURDATE()) < 61 AND payment_status='Paid' AND
    1=1 ORDER BY DaysTillRenewal DESC");
        
		echo "<table bgcolor='#a20000' border='0' width='750'><tr bgcolor='#a20000'><th class='jtable'><font color='#fff'>Name</font></th><th class='jtable'><font color='#fff'>Payment Status</font></th><th class='jtable'><font color='#fff'>Expiration Date</font></th><th class='jtable'><font color='#fff'>Days till Expiration</font></th><th class='jtable'><font color='#fff'>Action</font></th></tr>";
		while ($row = mysql_fetch_array($result)) {
			...
			echo "<td align='center'> <a href='edit_member.php?id=$row[id]'><img alt='Edit Item' width='18px' title='Edit Item' src='images/edit-icon.png'></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick='return confirmSubmit()' href='delete_member_expiring_users.php?id=$row[id]'><img alt='Delete Item' title='Delete Item' width='18px' src='images/delete-icon.png'></a></td>";
			echo "</tr>";
