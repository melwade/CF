   ...
   <div class="position_content" id="page_position_content">
    <div class="clearfix colelem" id="pu9501-3"><!-- group -->
     ...
     <div class="Quick-Links-Style clearfix grpelem" id="u5512-10"><!-- content -->
         <p>Quick Links: <a class="nonblock" href="http://www.meetup.com/cyclefolsom" target="_blank">CF Meetup.com Site</a>&nbsp;| <a class="nonblock" href="http://app.strava.com/clubs/cycle-folsom" target="_blank">CF Strava Club<span id="u5512-6"></span></a><? if ($_SESSION['myusername']) { ?> |&nbsp;&nbsp;<a class="nonblock" href="/member-tools/logout.php" target="_blank"><img style="vertical-align:middle; margin-bottom:2px;" src="images/logout_header.png"><span id="u5512-6"></span></a> <? } ?></p>
     </div>
       ...
       <div class="SubMenu  MenuLevel1 clearfix" id="u15425"><!-- vertical box -->
        <ul class="SubMenuView clearfix colelem" id="u15426"><!-- vertical box -->
         <li class="MenuItemContainer clearfix colelem" id="u15691"><!-- horizontal box -->
          <a class="nonblock nontext MenuItem MenuItemWithSubMenu Sub-Menu-Items clearfix grpelem" id="u15692" href="/membership-tools.html"><!-- horizontal box --><div class="MenuItemLabel NoWrap Sub-Menu-Item clearfix grpelem" id="u15693-4"><!-- content --><p>Membership Tools</p></div></a>
         </li>
         <li class="MenuItemContainer clearfix colelem" id="u15691"><!-- horizontal box -->
          <a class="nonblock nontext MenuItem MenuItemWithSubMenu Sub-Menu-Items clearfix grpelem" id="u15692" href="/guest.html"><!-- horizontal box --><div class="MenuItemLabel NoWrap Sub-Menu-Item clearfix grpelem" id="u15693-4"><!-- content --><p>Invited Guest Liability waiver</p></div></a>
         </li>
