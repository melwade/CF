...
th.jtable {padding: 5px; font-size:14px; text-align:center !important;} /* or you can target individual cells */
  ...
  <title>Paid Coupon Members</title>
  <!-- CSS -->
...
?><script>dhtmlx.alert("There was an error processing your request.");</script><? 
  ...
  include('CF_header.php'); ?>
      ...
      <h1 class="Heading-1" style="margin-bottom:25px;">Paid Coupon Members</h1>
	  <?
		include ('connect.php');
    ...
    /*	$result = mysql_query("SELECT id, fname, lname, payment_status, expiration_date,
      ...
      */
	    ...
	    FROM tblUserData
		WHERE
		payment_status='Paid' and coupon_user='Yes' and approval_date != '' and
	    1=1 ORDER BY expiration_date DESC");
		...
		while ($row = mysql_fetch_array($result)) {
			...
			echo "<td align='center'> <a href='edit_member.php?id=$row[id]'><img alt='Edit Item' width='18px' title='Edit Item' src='images/edit-icon.png'></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a onclick='return confirmSubmit()' href='delete_member_paidcoupon_users.php?id=$row[id]'><img alt='Delete Item' title='Delete Item' width='18px' src='images/delete-icon.png'></a></td>";
			echo "</tr>"; 
