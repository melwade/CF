...
$log_admin_notes = addslashes($_POST['log_admin_notes']);
$admin_name = $_SESSION['adminname'];

if($_POST['log_action_mailed']!=''){
	$result=mysql_query("INSERT into tblUserActionLog (admin_name,member_id,action) VALUES ('$admin_name','$member_id','Membership Card Mailed')");
}
if($_POST['log_action_meetup_approved']!=''){
	$result=mysql_query("INSERT into tblUserActionLog (admin_name,member_id,action) VALUES ('$admin_name','$member_id','Meetup Approved')");
}
if($_POST['log_action_expired']!=''){
	$result=mysql_query("INSERT into tblUserActionLog (admin_name,member_id,action) VALUES ('$admin_name','$member_id','Membership Expired')");
}
if($_POST['log_action_meetup_removed']!=''){
	$result=mysql_query("INSERT into tblUserActionLog (admin_name,member_id,action) VALUES ('$admin_name','$member_id','Meetup Membership Removed')");
}
if($_POST['log_action_canceled']!=''){
	$result=mysql_query("INSERT into tblUserActionLog (admin_name,member_id,action) VALUES ('$admin_name','$member_id','Membership Canceled')");
}
if($_POST['log_admin_notes']!=''){
	$result=mysql_query("INSERT into tblUserActionLog (admin_name,member_id,action) VALUES ('$admin_name','$member_id','$log_admin_notes')");
}

//Get post values	

$meetup_username = addslashes($_POST['meetup_username']);
$membership_processed = $_POST['membership_processed'];
...
if($_POST['log_action_expired']!=''){
	$payment_status='Expired-Processed';}
	else {
...
$query = "update tblUserData
			 ...
			 membership_processed = '.$membership_processed.',
