...
<div class="TabbedPanels" id="TabbedPanels1">
		<ul class="TabbedPanelsTabGroup">
            ...
            <li class="TabbedPanelsTab">Address Block</li> 
		</ul>
...
<div style="margin-top:5px; margin-bottom:5px;" ><a href="" onClick="AddressBlock(); return false;">Generate Address Block</a></div>
<div style="clear: both;"></div>
<div class="_33">
...
<div class="_15cal">
   ...
   <div class="_5cal"> <p class="contactform"><label class="bold_label" for="cancel_date"><br /></label> <A HREF="#"
...
<div class="_15cal">
   ...
   <div class="_5cal"> <p class="contactform"><label class="bold_label" for="meetup_removal_date"><br /></label> <A HREF="#"
...
<? } ?>
 ...
 <div class="TabbedPanelsContent">
	<? echo $mailer_name."<BR>";
	   echo $mailer_address1."<BR>"; 
	   echo $mailer_address2."<BR>"; ?>
