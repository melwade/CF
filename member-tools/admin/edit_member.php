...
<div class="_20">
    <p class="contactform"><label id="membership_processed_label" class="bold_label" for="in_user">New Processed</label>
        <select class="contactform" name="membership_processed" onChange="Contact_Change('membership_processed_label');" id="membership_processed">
            <option value="1" <?  if ($item['membership_processed']=="1")	{echo " selected ";}?>>Yes</option>
            <option value="0" <?  if ($item['membership_processed']=="0")	{echo " selected ";}?>>No</option>
        </select>
    </p>
</div>

<div class="_20">
    <p class="contactform"><label id="opt_in_label" class="bold_label" for="in_user">Newsletter Opt In?</label>
...
<!-- Action Log Options -->
<div class="_100">
    <p class="contactform"><label id="log_action_label" class="bold_label" for="logs">Log Action</label><br />
    <input type="checkbox" name="log_action_mailed" id="log_action_mailed">
    	<label for="log_action_mailed">Card Mailed</label> &nbsp;&nbsp;&nbsp;<br />
    <input type="checkbox" name="log_action_meetup_approved" id="log_action_meetup_approved">
    	<label for="log_action_meetup_approved">Meetup Approved</label> &nbsp;&nbsp;&nbsp;<br />&nbsp;<br />
    <input type="checkbox" name="log_action_expired" id="log_action_expired">
    	<label for="log_action_expired">Membership Expired</label> &nbsp;&nbsp;&nbsp;<br />
    <input type="checkbox" name="log_action_meetup_removed" id="log_action_meetup_removed">
    	<label for="log_action_meetup_removed">Meetup Removed</label> &nbsp;&nbsp;&nbsp;<br />
    <input type="checkbox" name="log_action_canceled" id="log_action_canceled">
    	<label for="log_action_canceled">User Canceled</label>&nbsp;&nbsp;&nbsp;<br />&nbsp;<br />
    Admin Note (enter below):<br />
    <input autocomplete="off" class="contactform" id="log_admin_notes" name="log_admin_notes" type="text" maxlength="1000"/>
    </p>
</div>
...
<div class="_100">
<p style="margin-top:15px;" class="contactform"><label id="log_table" class="bold_label" for="notes">Action Log</label></p>
<? $query  = "SELECT * FROM tblUserActionLog where member_id='$id' order by dtStamp asc";
	$result = mysql_query($query);
	echo "<table border='0'><tr bgcolor='#a20000'><th class='jtable' nowrap>Action Date</th><th class='jtable' nowrap>Admin</th><th class
	='jtable'>Action</th></tr>";
	while ($row = mysql_fetch_array($result)) {
	if($bgcolor=='#f4f4e9'){$bgcolor='#e0dfc9';}
	else{$bgcolor='#f4f4e9';}
	echo "<tr bgcolor=$bgcolor><td class='jtable' nowrap>".$row['dtStamp']."</td><td class='jtable' nowrap>".$row['admin_name']."</td><td class='jtable'>".$row['action']."</td></tr>";
	}
	echo "</table>";
	?>	
    </div>
...
<div class="_20">
    <p class="contactform"><label id="card_sent_label" class="bold_label" for="in_user">How Card Sent</label>
	<input autocomplete="off" class="contactform" id="card_sent" name="card_sent" type="text" value="<? echo ($item['card_sent']); ?>" readonly />
...
<div class="_15cal">
    <p class="contactform"><label id="cancel_date_label" class="bold_label" for="cancel_date">Date Canceled</label><input autocomplete="off" class="contactform" id="cancel_date" onChange="Contact_Change('cancel_date_label');" name="cancel_date" type="text" value="<? echo ($item['cancel_date']=='') ? "" : date('m/d/Y', (strtotime($item['cancel_date']))); ?>" readonly />
   </p> </div>
...
<!-- Notes Sections - Deprecated -->
    <div class="_100">
    <p style="margin-top:15px;" class="contactform"><label id="notes_label" class="bold_label" for="notes">Notes</label><textarea rows="4" class="contactform" id="notes" onChange="Contact_Change('notes_label');" name="notes" value="<?php echo stripslashes($item['notes']); ?>" readonly /><?php echo stripslashes($item['notes']); ?></textarea></p></div>
     <div style="clear: both;"></div>	
     
      <div class="_100">
    <p style="margin-top:15px;" class="contactform"><label id="cancel_reason_label" class="bold_label" for="notes">Member Reason for Canceling</label><textarea rows="2" class="contactform" id="cancel_reason" onChange="Contact_Change('cancel_reason_label');" name="cancel_reason" value="<?php echo stripslashes($item['cancel_reason']); ?>" readonly /><?php echo stripslashes($item['cancel_reason']); ?></textarea></p>
