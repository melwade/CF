...
<html class="html">
	<head>
        ...
        <title>Training - New Member Ride</title>
        <!-- CSS -->
	...
	<body>
        ...
        ?><script>dhtmlx.alert("There was an error processing your request.");</script><? 
          ...
          include('CF_header.php'); ?>
              ...
              <h1 class="Heading-1" style="margin-bottom:25px;">Training - New Member Ride</h1>
              <?
                include ('connect.php');
                $result = mysql_query("SELECT id, fname, lname, payment_status, expiration_date
                FROM tblUserData
                WHERE
                  training_status=2 AND
                  payment_status='Paid'
                ORDER BY expiration_date DESC");
                
                echo "<table bgcolor='#a20000' border='0' width='650'><tr bgcolor='#a20000'><th class='jtable'><font color='#fff'>Name</font></th><th class='jtable'><font color='#fff'>Expiration Date</font></th><th class='jtable'><font color='#fff'>Action</font></th></tr>";
