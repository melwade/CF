	...
	if ( $token != "" )
	{
		...
		*/
		...
		if( $ackGetExpressCheckout == "SUCCESS" || $ackGetExpressCheckout == "SUCESSWITHWARNING") 
		{
			...
			* page		
			*/
            $mylinky1 		    = $resArrayGetExpressCheckout["PAYMENTREQUEST_0_CUSTOM"]; // ' Email address of payer.
			$mylinky2		    = $resArrayGetExpressCheckout["PAYMENTREQUEST_0_INVNUM"]; // ' Email address of payer.

            $mylinky3		    = $resArrayGetExpressCheckout["L_PAYMENTREQUEST_0_NUMBER0"]; // ' Email address of payer.                
		...
		*/
		...
		?>
    		...
    		<span class="span5">
                ...
                <?php echo"field 1 - ".($mylinky1) ?><br>
                <?php echo"field 2 - ".($mylinky2) ?><br>

<?php echo"field 3 - ".($mylinky3) ?><br>
                
				<?php echo($shipToName) ?><br>
				<?php echo($shipToStreet) ?><br>
				<?php echo($shipToCity) ?><br>
				<?php echo($shipToState) ?>- <?php echo($shipToZip) ?></p>
    			<p>Description: <?php  echo($itemdescription);?> </p>
